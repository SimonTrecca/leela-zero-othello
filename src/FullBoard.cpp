...
//this removes an entire group of stones
...
//this creates a unique hash for the current board state in order to check for the ko rule (you can't immediately repeat a previous gamestate)
